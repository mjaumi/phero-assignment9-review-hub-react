        ...
        <header className='fixed w-full bg-review-hub-base-dark text-review-hub-base-green py-5 z-[99999]'>
            <div className='flex justify-between w-11/12 lg:w-4/5 mx-auto'>
                ...
                <div className='flex items-center'>
                    <nav className={`flex flex-col w-full bg-review-hub-base-dark md:w-fit md:flex-row text-base lg:text-xl absolute top-48 left-0 md:static duration-500 ease-in-out ${open ? 'top-10' : 'top-[-250px]'} -z-10`}>
