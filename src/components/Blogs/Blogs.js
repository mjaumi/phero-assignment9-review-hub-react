...
const Blogs = () => {
    return (
        <section className='py-36 min-h-screen'>
            <h2 className='font-light text-2xl md:text-4xl mb-20 text-review-hub-base-green'>Questions & Answers</h2>
            <div className='text-left w-[90%] md:w-4/5 mx-auto border-2 border-review-hub-base-green p-5 rounded-3xl'>
            ...
            <div className='mt-10 text-left w-[90%] md:w-4/5 mx-auto border-2 border-review-hub-base-green p-5 rounded-3xl'>
